...
impl Request {
    ...
    fn clone_from(r: &Request, can_gc: CanGc) -> Fallible<DomRoot<Request>> {
        ...
        *r_clone.request.borrow_mut() = new_req_inner;
        ...
        // Step 2. If request’s body is non-null, set newRequest’s body to
        // the result of cloning request’s body.
        ...
        if let Some(body_stream) = r.body_stream.get() {
            r_clone.body_stream.set(Some(&*body_stream));
        }
